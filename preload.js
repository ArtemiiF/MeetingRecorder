...
contextBridge.exposeInMainWorld("api", {
  ...
  deleteHistoryNote: (notePath, baseStamp, title) => ipcRenderer.invoke("delete-history-note", { notePath, baseStamp, title }),
  ...
  restoreTrashEntry: (id) => ipcRenderer.invoke("restore-trash-entry", { id }),
  deleteTrashEntry: (id) => ipcRenderer.invoke("delete-trash-entry", { id }),
